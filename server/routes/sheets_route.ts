    ...
    public static create(router: Router) {
        ...
        router.post('/sheetdata/delete-metadata',
            ...
            (req: Request, res: Response, next: NextFunction) => {
                ...
                SheetsManagementOperations.deleteMetadata(accessToken, spreadsheetNames)
                    .then(result => {
                        res.send(result);
                    }).catch(err => {
                        res.send({ error: err });
        ...
        router.post('/sheetdata/enrolle-user-spreadsheet',
            ...
            (req: Request, res: Response, next: NextFunction) => {
                ...
                SheetsManagementOperations.enrolleUserSpreadsheet(accessToken, enrolledUser)
                    .then(result => {
                        res.send(result);
                    }).catch(err => {
                        res.send({ error: err });
        ...
        router.post('/sheetdata/select',
            (req: Request, res: Response, next: NextFunction) => {
                ...
                SheetsSelectOperations.selectEntity(accessToken, spreadsheetName, sheetName, entityName, select, addSchema)
                    .then(result => {
                        res.send(result);
                    }).catch(err => {
                        res.send({ error: err });
        ...
        router.post('/sheetdata/getscalar',
            (req: Request, res: Response, next: NextFunction) => {
                ...
                SheetsSelectOperations.selectEntity(accessToken, spreadsheetName, sheetName, entityName, select, false, true)
                    .then(result => {
                        res.send(result);
                    }).catch(err => {
                        res.send({ error: err });
